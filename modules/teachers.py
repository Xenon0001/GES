...
class Profesores(cus.CTkFrame):
    ...
    def cargar_estudiamtes(self):
        ...
        cursor = conn.cursor()
        cursor = conn.cursor()
        cursor.execute("SELECT nombre, apellido, curso, procedencia FROM estudiantes")
    ...
    def create_Widgets(self):
        ...
        tabs.add(self.tab_search, text="Buscar profesor")
        tabs.add(self.tab_add, text="Agregar profesor")
        ...
        self.entry_name = cus.CTkEntry(cont, placeholder_text="Nombre del estudiante", width=200, height=35)
        self.entry_apellido = cus.CTkEntry(cont, placeholder_text="Apellido", width=200, height=35)
        self.entry_cuso = cus.CTkEntry(cont, placeholder_text="Curso", width=200, height=35)
        self.entry_fecha = cus.CTkEntry(cont, placeholder_text="Fecha de nacimiento", width=200, height=35)
        self.entry_procedencia = cus.CTkEntry(cont, placeholder_text="Centro de procedencia", width=200, height=35)
        self.entry_tutor1 = cus.CTkEntry(cont, placeholder_text="Nombre del tutor 1", width=200, height=35)
        self.entry_tutor2 = cus.CTkEntry(cont, placeholder_text="Tutor 2", width=200, height=35)
        self.entry_tell = cus.CTkEntry(cont, placeholder_text="Tell: +240 *** *** ***", width=200, height=35)
        self.entry_direccion = cus.CTkEntry(cont, placeholder_text="Direción", width=200, height=35)
        ...
        self.entry_cuso.grid(row=1, column=0, sticky="nsew", padx=5, pady=10)
        self.entry_fecha.grid(row=1, column=1, columnspan=2, sticky="nsew", padx=5, pady=10)
        self.entry_procedencia.grid(row=2, column=0, columnspan=2, sticky="nsew", padx=5, pady=10)
        self.entry_tutor1.grid(row=2, column=2, sticky="nsew", padx=5, pady=10)
        self.entry_tutor2.grid(row=3, column=0, sticky="nsew", padx=5, pady=10)
        self.entry_tell.grid(row=3, column=1, columnspan=2, sticky="nsew", padx=5, pady=10)
        self.entry_direccion.grid(row=4, column=1, sticky="nsew", padx=5, pady=10)

        self.add_student = cus.CTkButton(cont, text="Agregar estudiante", command=self.agregar_estudiantes)
        self.add_student.grid(row=5, column=0, columnspan=3, sticky="nsew", pady=(40, 20), padx=80)
    ...
    def limpiar_campos(self):
        for entry in [self.entry_name, self.entry_apellido, self.entry_cuso, self.entry_fecha,
